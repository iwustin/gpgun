...
@Setter
@Getter
public final class MagazineGun extends Common {
    @NonNull
    @JsonIgnore
    private final ItemFactory factory = Factory.MAGAZINE_GUN;
    ...
    @Nullable
    @JsonProperty(Property.DISPLAY_AMMO_STATE)
    private String displayAmmoState;
    @Nullable
    @JsonProperty(Property.DISPLAY_AMMO_NAME)
    private String displayAmmoName;
    @Nullable
    @JsonProperty(Property.DISPLAY_AMMO_STATE_YES)
    private String displayAmmoStateYes;
    @Nullable
    @JsonProperty(Property.DISPLAY_AMMO_STATE_NO)
    private String displayAmmoStateNo;
    @Nullable
    ...
    @Nullable
    @JsonProperty(Property.WITHOUT_ITEM_MODEL)
    private String withoutItemModel;
    @Nullable
    @JsonProperty(Property.ITEM_MODEL_SCOPE)
    private String itemModelScope;
    @Nullable
    @JsonProperty(Property.WITHOUT_ITEM_MODEL_SCOPE)
    private String WithoutItemModelScope;
